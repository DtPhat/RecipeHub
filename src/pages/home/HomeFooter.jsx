...
const HomeFooter = () => {
    return (
        <section className='p-4 bg-green-950 text-green-50 mt-24 flex flex-col md:flex-row items-center justify-between'>
            ...
            {/* <a href='https://recipehub.herokuapp.com/swagger-ui/index.html#/' target='_blank' className='font-semibold text-green-500 text-2xl'>&lt;Backend API documentation&gt;</a> */}
