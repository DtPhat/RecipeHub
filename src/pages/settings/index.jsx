...
const Settings = () => {
  ...
  return (
    <section className='flex justify-center py-4 lg:mx-8 gap-6'>
      <div className='border-gray-400 rounded max-w-7xl w-full space-y-8 bg-container py-4 px-8 min-h-[90vh]'>
        ...
        <div className='pl-4 space-y-8'>
          <div className='relative space-y-2'>
            ...
            <input type={showingPassword ? 'text' : 'password'} className='pb-2 pt-4 text-lg px-2 bg-container border-b-2 focus:outline-gray-200 w-full pr-12' name='password' id='password' placeholder='Current password'
              onChange={handleLoginDataChange} />
            {loginData.password && <button className='absolute top-11 right-3 text-gray-400 hover:text-gray-600 bg-container z-10'
          ...
          <div className='relative space-y-2'>
            ...
            <input type={showingNewPassword ? 'text' : 'password'} className='pb-2 pt-4 text-lg px-2 bg-container border-b-2 focus:outline-gray-200 w-full pr-12' name='newPassword' id='newPassword' placeholder='New password'
              onChange={handleLoginDataChange} />
            {loginData.password && <button className='absolute top-11 right-3 text-gray-400 hover:text-gray-600 bg-container z-10'
          ...
          <div className='relative space-y-2'>
            ...
            <input type={showingConfirmNewPassword ? 'text' : 'password'} className='pb-2 pt-4 text-lg px-2 bg-container border-b-2 focus:outline-gray-200 w-full pr-12' name='confirmNewPassword' id='confirmNewPassword' placeholder='Confirm new password'
              onChange={handleLoginDataChange} />
            {loginData.password && <button className='absolute top-11 right-3 text-gray-400 hover:text-gray-600 bg-container z-10'
