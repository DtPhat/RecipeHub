...
const Skeleton = () => {
  return (
    <div className="w-full max-w-8xl p-4 space-y-4 border border-gray divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700">
