      ...
      <div className='w-full flex justify-center'>
        <div className='max-w-8xl w-full flex space-x-4 rounded lg:px-4 py-4 justify-center '>
          <div className='border-gray-400 rounded max-w-6xl w-full justify-center space-y-4 bg-gray-50 py-4 px-8'>
            <div className='select-none flex gap-4 justify-between pb-2 border-b-2 border-green-accent text-green-accent'>
              ...
              <div className='hover:bg-gray-200 rounded cursor-pointer p-2 wp-auto sm:w-44 flex justify-center items-center'
